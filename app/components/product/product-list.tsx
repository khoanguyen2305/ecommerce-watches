...
export default function ProductList () {
    const products = ["", "", ""];
    return (
        <div id="product" className="max-w-10xl flex justify-center items-center py-2 md:px-8 lg:px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                {products.map((product, index) => (
                    <Link href="/product/123" key={index}>
                        <Image src={WatchProduct} alt="img" className="w-full object-center rounded-lg"/>
